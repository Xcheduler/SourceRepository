            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="create-account-page text-center animated fadeIn delay-2000">
                        ...
                        <h4> Please enter your email address and password to create your account </h4>
                        <div class="row">
                            <div class="col-xs-offset-2 col-xs-8 col-sm-offset-3 col-sm-6 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4">
                                ...
                                <form id="RegForm" name="RegForm" method="post" action="RegistrationAction.do" >
                                    <div class="row">
                                        <div class="col-xs-12 col-xl-6">
                                            <div class="form-group floating-labels">
                                                <label for="username">Username</label> <input id="username" autocomplete="off" type="text" name="username" onblur="myFunction()"> 
                                        ...
                                        <div class="col-xs-12 col-xl-6">
                                            <div class="form-group floating-labels">
                                                <label for="company">Company Name / Account Name</label> <input id="company" autocomplete="off" type="text" name="company" onblur="myFunction()"> 
                                                <p class="error-block"></p>
                                            </div>
                                        </div>
                                    ...
                                    <br> 
                                    <p class="text-center">By clicking on create account, you agree to our terms of service and that you have read our privacy policy, including our cookie use policy</p>
                                    <div class="row buttons">
                                        <div class="col-xs-12"> <input type="submit" class="btn btn-lg btn-info btn-block no-border" value="Create account" onClick="return registerSubmitForm();"> </div>
										If you have already account, Please <a href="/scheduler" style="color: rgb(0,255,0)"><font color="FF00CC">Login</font></a>
									</div>
